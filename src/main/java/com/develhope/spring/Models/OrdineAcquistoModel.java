...
public class OrdineAcquistoModel {
    ...
    public OrdineAcquistoModel(Long ordineAcquistoId, OffsetDateTime dataOrdineAcquisto, OffsetDateTime dataConsegna, BigDecimal anticipo, Boolean flagPagato, StatoOrdineAcquisto statoOrdineAcquisto, Acquirente acquirente, Vehicle vehicle, Venditore venditore) {
    ...
    public OrdineAcquistoModel(OffsetDateTime dataOrdineAcquisto, OffsetDateTime dataConsegna, BigDecimal anticipo, Boolean flagPagato, StatoOrdineAcquisto statoOrdineAcquisto, Acquirente acquirente, Vehicle vehicle, Venditore venditore) {
    ...
    public static OrdineAcquistoDTO modelToDto(OrdineAcquistoModel ordineAcquistoModel) {
        return new OrdineAcquistoDTO(ordineAcquistoModel.getOrdineAcquistoId(), ordineAcquistoModel.getDataOrdineAcquisto(), ordineAcquistoModel.getDataConsegna(), ordineAcquistoModel.getAnticipo(), ordineAcquistoModel.getFlagPagato(), ordineAcquistoModel.getStatoOrdineAcquisto(), ordineAcquistoModel.getAcquirente(), ordineAcquistoModel.getVehicle(), ordineAcquistoModel.getVenditore());
    }
